                            ...
                            <tbody>
                                @foreach($loads as $load)
                                    <tr>
                                        ...
                                        <td>{{$load->time}}</td>
                                        <td>
                                            <a href="#" data-from="{{$load->from_address}}" data-to="{{$load->to_address}}" class="btn map btn-primary text-white btn-xs">View</a>
                                        </td>
                                        <td>
                                            <a href="{{route('load_update',[$load->id])}}" class="btn btn-warning text-white btn-xs">update</a>
                                        </td>
                                        <!-- <td>
                                            <a href="{{route('load_delete',$load->id)}}" class="btn btn-danger text-white btn-xs">delete</a>
                                        </td> -->
                                        <td>
                                            <a href="#" data-load_id="{{$load->id}}" class="btn cancel btn-danger text-white btn-xs">Cancel</a>
                                        </td>
                                        </tr>
                                @endforeach
                            </tbody>
  ...
  height: 100vh;
    ...
    <div class="modal fade bs-example-modal-lg1" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title mt-0" id="myLargeModalLabel"> Cancel Load</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
