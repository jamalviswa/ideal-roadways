                    ...
                    <div class="card-body">
                    	<form method="POST" action="{{route('branch_update',$branch->id)}}">
                    		...
                    		<div class="form-group">
                    			...
                    			<input type="text" value="{{ $branch->name }}" name="branch_name" class="form-control">
                                @error('branch_name')
                    		...
                    		<div class="form-group">
                    		    ...
                    		    <select class="form-control" name="state" id="state" onchange="getDistrict()">
                                    ...
                                    @foreach($states as $state)
                                        @if($state->id==old('state') || $state->id==$branch->state)
                            ...
                            <div class="form-group"  id="district_con">
                                ...
                                <select class="form-control" id="district" name="district">
                                   ...
                                   @foreach($districts as $dist)
                                        @if($dist->id==old('district') || $dist->id==$branch->district)
                            ...
                            <div class="form-group">
                                <label>Address</label>
                                <textarea class="form-control" name="address">{{$branch->location}}</textarea>
                            </div>
                            <div class="form-group">
