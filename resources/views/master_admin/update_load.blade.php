        ...
        <div class="row">
            <div class="col-7" style="margin: auto;">
                <div class="card m-b-30">
                    ...
                    <div class="card-body">
                    	<form method="POST" action="{{route('load_update_post',$load->id)}}">
                    		@csrf
                    		<div class="form-group">
                    			<label>Load Name</label>
                    			<input type="text" value="{{$load->name}}" name="name" class="form-control">
                                @error('name')
                    		...
                    		<div class="form-group">
                                ...
                                <textarea autocomplete="off" class="form-control" id="from_address" name="from_address">{{$load->from_address}}</textarea>
                    	      @error('from_address')
                                    <div class="error">{{ $message }}</div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea autocomplete="off" class="form-control" id="to_address" name="to_address">{{$load->to_address}}}</textarea>
                                @error('to_address')
                                    <div class="error">{{ $message }}</div>
                            ...
                            <div class="form-group">
                                <label>Date</label>
                                <input type="date" name="date" value="{{$load->date}}" class="form-control">
                                @error('date')
                                    <div class="error">{{ $message }}</div>
                                @enderror 
                            </div>
