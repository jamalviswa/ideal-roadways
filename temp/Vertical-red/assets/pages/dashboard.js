...
!function ($) {
    ...
    Dashboard.prototype.init = function () {
        ...
        this.createAreaChart('morris-area-example', 0, 0, $areaData, 'y', ['a', 'b', 'c'], ['Series A', 'Series B', 'Series C'], ['#508aeb', '#fcc24c', '#fd6e77']);
        ...
        this.createDonutChart('morris-donut-example', $donutData, ['#54cc96', "#fd6e77", '#508aeb', '#fcc24c']);
